"""Konstanten für die Verträge-Integration."""
...
NOTIFY_ID_PREFIX = "vertraege_kuendigung_"

# Zukünftiger Vertrag -> entry.options, gleiche Keys mit Präfix
NEXT_PREFIX = "next_"

# Felder, die beim Wechsel nächster -> aktuell übernommen werden.
# Nicht im "nächsten" Vertrag angegebene Felder behalten ihren aktuellen Wert
# (z. B. Zählernummer bleibt beim Anbieterwechsel erhalten).
BASIS_FELDER = [
    CONF_ANBIETER,
    CONF_KUNDENNUMMER,
    CONF_TARIF,
