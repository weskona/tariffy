"""Sensoren der Verträge-Integration."""
...
class VertragSensor(CoordinatorEntity[VertraegeCoordinator], SensorEntity):
    _attr_has_entity_name = True
    entity_description: VertragSensorDescription

    def __init__(
        self,
        coordinator: VertraegeCoordinator,
        entry: "VertraegeConfigEntry",
