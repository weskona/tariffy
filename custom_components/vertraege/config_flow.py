"""Config- und Options-Flow der Verträge-Integration (sparten-abhängig)."""
...
# ------------------------------------------------------------------- flows
class VertraegeConfigFlow(ConfigFlow, domain=DOMAIN):
    ...
    def async_get_options_flow(config_entry) -> OptionsFlow:
        return VertraegeOptionsFlow()


class VertraegeOptionsFlow(OptionsFlow):
