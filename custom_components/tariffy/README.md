...
- **Guthaben/Nachzahlung (Bisher)** (nur Energie-Sparten) = `abschlag × vergangene_monate − kosten_bisher` → `40 € × 6,31 − 513,54 €` = **−261,24 €** (Nachzahlung). Anders als `prognose_real` KEINE Hochrechnung auf die volle Vertragslaufzeit, sondern der exakte Stand zum heutigen Tag.
